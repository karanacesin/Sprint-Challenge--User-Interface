...
4. Explain why git is valuable to a team of developers.
    ...
    it allows each person to work on things separately and merge together. you are able to go back and look at  previous versions and compare changes

5. Define mobile-first design in your own words.

    coding a website for mobile first and using min-width to scale up to a desktop site
